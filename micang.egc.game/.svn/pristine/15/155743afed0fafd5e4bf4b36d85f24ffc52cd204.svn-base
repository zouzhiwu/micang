...
//		aList.add(999L);
//		Boolean physicals = friendService.getPhysicals(1101L, aList);
//		System.out.println(physicals);
	}
	...
	private static void templateConfigInit() {
		...
		HeroProficiencyConfig.init();
		logger.info("HeroProficiencyConfig Config config finish.");
		KillHeroExpConfig.init();
		logger.info("KillHeroExpConfig Config config finish.");
	}
