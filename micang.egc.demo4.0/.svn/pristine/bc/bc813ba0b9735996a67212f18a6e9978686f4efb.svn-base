...
public class MemberAction {
	...
	@Action(MessageCode.hero_proficiency_update)
	public void heroProficiencyUpdate(Message message, Channel channel) {
		long memberId = message.getLong();
		int heroTemplateId = message.getInt();
		meberService.heroProficiencyUpdate(message.getAccountId(), memberId, heroTemplateId);
	}
